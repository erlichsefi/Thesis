...
public class Agent {
	...
	String agentname;
	dissagrement dissagrementValue;
    ...
    public dissagrement getdissagramntvalue(){
		return new dissagrement(dissagrementValue);
	}


	public void setdissagramntvalue(dissagrement d){
		this.dissagrementValue=new dissagrement(d);
	}
